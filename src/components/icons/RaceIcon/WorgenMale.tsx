...
export const WorgenMaleIcon: React.FC<{ size?: number }> = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Sourcils épais */}
    <rect x="18" y="19" width="4" height="1" rx="0.5" fill="#222" />
    <rect x="26" y="19" width="4" height="1" rx="0.5" fill="#222" />
  </svg>
)