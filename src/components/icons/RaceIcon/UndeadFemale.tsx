...
export const UndeadFemaleIcon: React.FC<{ size?: number }> = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Cheveux violets */}
    <path d="M12 16 Q24 6 36 16 Q34 12 24 14 Q14 12 12 16" fill="#A78BFA" stroke="#6B7280" strokeWidth="1" />
    {/* Sourcils fins */}
    ...
    {/* Cicatrice */}
    <path d="M26 28 Q28 30 30 28" stroke="#DC2626" strokeWidth="1" fill="none" />
  </svg>
)